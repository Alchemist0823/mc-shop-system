...
function commerce_kickstart_menus_menu_alter(&$items) {
  ...
  if (isset($items['admin/commerce/jirafe'])) {
    $items['admin/commerce/jirafe']['title'] = 'Analytics';
    $items['admin/commerce/jirafe']['parent'] = 'admin';
    $items['admin/commerce/jirafe']['weight'] = 49;
    $items['admin/commerce/jirafe']['options'] = array(
        'toolbar_break' => TRUE,
        'toolbar_css' => 'reports',
    );
  }
 ...
 */
/*
function commerce_kickstart_menus_init() {
  $item = menu_get_item();
 ...
 */
/*
function mymcshop_menus_views_api() {
  return array(
      'api' => 3,
      'path' => drupal_get_path('module', 'mymcshop_menus') . '/views',
  );
}*/
